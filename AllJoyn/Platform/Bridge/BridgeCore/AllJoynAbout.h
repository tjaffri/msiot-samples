...
namespace Bridge
{
	...
	public:
		...
		QStatus SetManufacturer(_In_z_ const char *value);
		QStatus SetDeviceName(_In_z_ const char *value);
		QStatus SetSWVersion(_In_z_ const char *value);
        QStatus SetHWVersion(_In_z_ const char *value);
        QStatus SetApplicationName(_In_z_ const char *value);
        QStatus SetApplicationGuid(_In_ const char *value);
        QStatus SetDeviceId(_In_z_ const char *value);
        QStatus SetModel(_In_z_ const char *value);
        QStatus SetDescription(_In_z_ const char *value);
	...
	private:
		...
		QStatus CreateAndSaveDeviceID(_Out_ std::string &deviceId);
		QStatus ReadDeviceID(_Out_ std::string &deviceId);
	};
}
