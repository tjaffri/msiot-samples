...
namespace Bridge
{
	...
	public:
        ...
        ///
        ///*******************************************************************************************************************************
        virtual QStatus PostFileWriteAction(_In_ std::wstring &appRelativeFileName, _Out_ std::shared_ptr<DsbBridge>& finalEvent) = 0;
        ...
        ///
        ///*******************************************************************************************************************************
        virtual QStatus PreFileReadAction(_Out_ std::wstring &appRelativeFileName) = 0;


        virtual QStatus PostFileReadAction(void) = 0;
	...
	private:
        ...
        std::atomic<bool> m_transferInProgress;
        ...
        std::string m_tempAppRelativeFileName;

        QStatus CreateTempFile();
		void DeleteTempFile();
	};
}
