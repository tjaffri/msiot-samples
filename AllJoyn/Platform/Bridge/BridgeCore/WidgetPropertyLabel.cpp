...
//
//**************************************************************************************************************************************
WidgetPropertyLabel::WidgetPropertyLabel(_In_ ControlPanel* pControlPanel, _In_ std::shared_ptr<IAdapterValue> srcValue)
...
QStatus WidgetPropertyLabel::GetValue(_Out_ alljoyn_msgarg val) const
{
	...
	std::string srcContent = m_srcValue->Data().ToString();
