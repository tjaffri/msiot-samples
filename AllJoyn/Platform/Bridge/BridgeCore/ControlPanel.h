...
namespace Bridge
{
    ...
    {
    public:
        ControlPanel(_In_ std::shared_ptr<IControlPanelHandler> controlPanelHandler, _In_ std::shared_ptr<IAdapterDevice> controlledDevice);
        virtual ~ControlPanel();

        virtual QStatus Initialize(_In_ std::shared_ptr<IAdapter> adapter, _In_ alljoyn_busattachment bus, _In_z_ const wchar_t *unitName, _In_z_ const wchar_t* panelName);
        ...
        std::shared_ptr<IAdapterDevice> GetDevice()
        {
    ...
    protected:
        ...
        std::shared_ptr<IControlPanelHandler> GetControlPanelHandler()
        {
    ...
    private:
        ...
        std::shared_ptr<IControlPanelHandler> m_controlPanelHandler;
        std::shared_ptr<IAdapterDevice> m_controlledDevice;
    ...
    {
    public:
        ControlPanelSimple(_In_ std::shared_ptr<IControlPanelHandler> controlPanelHandler, _In_ std::shared_ptr<IAdapterDevice> controlledDevice);
    ...
    private:
        ...
        std::shared_ptr<WidgetSignalHandler> m_pSignalHandler;
    };
    ...
    {
    public:
        ControlPanelUniversal(_In_ std::shared_ptr<IControlPanelHandler> controlPanelHandler, _In_ std::shared_ptr<IAdapterDevice> controlledDevice);
