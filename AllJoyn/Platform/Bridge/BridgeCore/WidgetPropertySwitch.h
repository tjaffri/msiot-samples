...
namespace Bridge
{
    ...
    {
    public:
        WidgetPropertySwitch(_In_ ControlPanel* pControlPanel, _In_ std::shared_ptr<IAdapterProperty> switchProperty, _In_ std::shared_ptr<IAdapterValue> switchValue);
    ...
    protected:
        ...
        std::shared_ptr<IAdapterProperty> m_switchProperty;

        // The actual Switch Value on a target device that this widget controls
        std::shared_ptr<IAdapterValue> m_switchValue;
